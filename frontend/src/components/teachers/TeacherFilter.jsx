...
const TeacherFilter = () => {
  ...
  return (
    <>
            <div>
            <h1 className="text-[16px] font-bold text-slate-900">Teachers</h1>
            <p className="text-sm text-slate-500 font-semibold">Manage all teachers in your institution OR College.</p>
        </div>
    <div className=" mt-5 rounded-xl border-2 border-slate-300  p-5 bg-gray-200 mb-5">
      ...
      <div className="grid md:grid-cols-6 gap-y-3 gap-x-8">
        ...
        <div className="flex  gap-2 ml-10">
          ...
          <button className="flex h-10 mt-6 items-center justify-center gap-2 whitespace-nowrap rounded-lg bg-blue-600 px-5 py-2 text-white hover:bg-blue-700 cursor-pointer">
            <Plus size={18} />
            Add Teacher
          </button>
        </div>
